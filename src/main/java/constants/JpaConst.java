...
*  インターフェイスに定義した変数は public static final
*  修飾子がついてるとみなされす
*/
public interface JpaConst {
   ...
   String EMP_COL_CODE = "code"; // 社員コード
   ...
   int EMP_DEL_FALSE = 0;// 削除フラッグOFF(現役)

   // 日報テーブル
   String TABLE_REP = "reports";  // テーブル名
   // 日報テーブルカラム
   String REP_COL_ID = "id"; // id
   String REP_COL_EMP = "employee_id"; // 日報を作成した従業員にid
